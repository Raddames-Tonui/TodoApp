          ...
          <div className="hidden md:flex items-center space-x-6">
            {currentUser ? (
              <>
                <NavLink
                  to="/users/tasks"
                  className="text-white hover:underline font-semibold hover:font-bold"
                >
                  My Tasks
                </NavLink>
                <NavLink
                  to="/users/profile_update"
                  className="text-white hover:underline font-semibold hover:font-bold"
                >
                  Update profile
                </NavLink>
              ...
              <>
                ...
                <NavLink
                  to="/users/signin"
                  className="flex justify-center items-center text-black font-semibold w-24 h-10 rounded-3xl text-sm font-inherit border-none overflow-hidden bg-gradient-to-r from-[#36e66e] to-[#f9f047] hover:bg-gradient-to-r hover:from-[#0fd850] hover:to-[#35ca22] transition-all duration-500 ring-slate-900 hover:ring-black"
                >
                  Sign In
                </NavLink>
              </>
            ...
            <div className="flex flex-col items-center space-y-6 py-4 px-6">
              {currentUser ? (
                <>
                  <NavLink
                    to="/users/tasks"
                    className="text-white hover:text-gray-900 text-2xl font-semibold"
